...
> = _T extends { readonly length: infer Len extends L }
  ? _T
...
type BuildRange<
  L extends number,
  _T extends readonly unknown[] = [],
  _Acc extends number = never
> = _T extends { readonly length: infer Len extends L }
  ? _Acc | _T['length']
  : BuildRange<L, [..._T, unknown], _Acc | _T['length']>

type NumberRange<L extends number, H extends number> = BuildRange<
  H,
  BuildTuple<L>
>
